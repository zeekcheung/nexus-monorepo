...
export const MonitorPageMetaPropsSchema = z.object({
   ...
   * @example 25
   */
  temperatureValue: z.number().optional().describe("Value of temperature"),
  /**
   * Unit of temperature.
   * @default "℃"
   */
   ...
   * @example 96
   */
  humidityValue: z.number().optional().describe("Value of humidity"),
  /**
   * Unit of humidity.
   * @default "%"
   */
  ...
  updateInterval: z
    .int()
    .min(0, { error: "updateInterval must be > 0" })
    .optional()
  ...
  elapsedHourValue: z
    .number()
    .min(0, { error: "elapsedHourValue must be >= 0" })
    .optional()
    .describe("Value of elapsed time in hours"),
  /**
   ...
   * @example 12
   */
  totalHourValue: z.number().optional().describe("Value of total time in hours"),
  /**
